...
class TestCourierLogin:
    ...
    # то через минуту от сервера приходит ошибка 504 Service unavailable, наставник сказала оставить так,
    # и добавить комментарий в код.)
...
# В этой проверке так же баг, как сказал наставник, из-за этого возвращается 404
